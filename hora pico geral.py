...
planilha = r'C:\Users\moesios\Desktop\AJUSTES P14\HORA PICO.xlsx'
...
hora_pico_geral = df_viagens['Intervalo'].value_counts().sort_values(ascending=False)

hora_pico_geral.to_excel(r'C:\Users\moesios\Desktop\AJUSTES P14\hora_pico_geral.xlsx')